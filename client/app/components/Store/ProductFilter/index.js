...
const priceMarks = {
  ...
  150000: { label: <p className='fw-normal text-black'>150,000</p> }
};
...
const ProductFilter = props => {
  ...
  return (
    <div className='product-filter'>
      <Card className='mb-4'>
        <CardHeader className='info' tag='h3'>Price</CardHeader>
        <CardBody>
      ...
      <Card>
        <CardHeader className='info' tag='h3'>Rating</CardHeader>
        <CardBody>
